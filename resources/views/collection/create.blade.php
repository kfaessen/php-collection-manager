...
<head>
    ...
    <title>Item Toevoegen - Collectiebeheer</title>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-8">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div>
                            <h1 class="h3">Item Toevoegen</h1>
                            <p class="text-muted">Voeg een nieuw item toe aan je collectie</p>
                        </div>
                            ...
                            <form method="POST" action="{{ route('collection.store') }}">
                                    ...
                                    <div class="col-12 col-md-8">
                                        ...
                                        @if(request('scanned') === 'true')
                                            <div class="alert alert-info">
                                                ...
                                                <strong>Barcode gescand!</strong> De onderstaande velden zijn automatisch ingevuld met data van externe APIs.
                                            </div>
                                        @endif
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select @error('type') is-invalid @enderror" 
                                                        ...
                                                        <option value="game" {{ old('type', request('type')) === 'game' ? 'selected' : '' }}>Game</option>
                                                        <option value="film" {{ old('type', request('type')) === 'film' ? 'selected' : '' }}>Film</option>
                                                        <option value="serie" {{ old('type', request('type')) === 'serie' ? 'selected' : '' }}>Serie</option>
                                                        <option value="book" {{ old('type', request('type')) === 'book' ? 'selected' : '' }}>Boek</option>
                                                        <option value="music" {{ old('type', request('type')) === 'music' ? 'selected' : '' }}>Muziek</option>
                                                    </select>
                                                    @error('type')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                   ...
                                                   id="platform" name="platform" value="{{ old('platform', request('platform')) }}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                                      ...
                                                      placeholder="Korte beschrijving van het item">{{ old('description', request('description')) }}</textarea>
                                            @error('description')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select @error('condition_rating') is-invalid @enderror" 
                                                        ...
                                                        <option value="5" {{ old('condition_rating', '5') == '5' ? 'selected' : '' }}>Uitstekend (5)</option>
                                    ...
                                    <div class="col-12 col-md-4">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('barcode') is-invalid @enderror" 
                                                   id="barcode" name="barcode" value="{{ old('barcode', request('barcode')) }}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="url" class="form-control @error('cover_image') is-invalid @enderror" 
                                                   id="cover_image" name="cover_image" value="{{ old('cover_image', request('cover_image')) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('notes') is-invalid @enderror" 
                                              ...
                                              placeholder="Extra notities over het item">{{ old('notes') }}</textarea>
                                    @error('notes')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
