...
<head>
    ...
    <title>TOTP Verificatie - Collection Manager</title>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="verify-card p-4 p-md-5">
                        <div class="text-center mb-4">
                            ...
                            <h2 class="mt-3 mb-1">TOTP Verificatie</h2>
                            <p class="text-muted">Voer je authenticatie code in</p>
                        </div>
                        ...
                        <form method="POST" action="{{ route('verify.totp') }}">
                            @csrf
