...
<head>
    ...
    <title>Gebruiker Bewerken - Collection Manager</title>
        ...
        <main class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
            <div class="px-4 py-6 sm:px-0">
                <div class="flex justify-between items-center mb-6">
                    <h1 class="text-2xl font-semibold text-gray-900">Gebruiker Bewerken: {{ $user->name }}</h1>
                ...
                <div class="bg-white shadow rounded-lg">
                    <form method="POST" action="{{ route('admin.users.update', $user) }}" class="p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <!-- Password -->
                            <div>
                                <label for="password" class="block text-sm font-medium text-gray-700">Nieuw Wachtwoord (leeg laten om niet te wijzigen)</label>
                            ...
                            <div>
                                <label for="password_confirmation" class="block text-sm font-medium text-gray-700">Nieuw Wachtwoord Bevestigen</label>
